...
<header id="top">
      <h1>
        <a href="../main/main.html">Perfume</a>
      </h1>
      <nav>
        <ul>
          <li class="category" id="ourstory">
            Our Story
            <ul class="dropdown">
              <li><a href="../ourStory/about.html">About</a></li>
              <li><a href="../ourStory/offline.html">Offline</a></li>
            </ul>
          </li>
          <li class="category" id="Best">
            Best
            <ul class="dropdown">
              <li><a href="../best/bestAll.html" id="all">All</a></li>
              <li><a href="../best/bestMan.html">Man</a></li>
              <li><a href="../best/bestWomen.html">Women</a></li>
            </ul>
          </li>
