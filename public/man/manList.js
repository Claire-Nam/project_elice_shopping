...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    const manCategory = categories.find((category) => category.name === "Men");
    const manProducts = manCategory ? manCategory.products : [];
    ...
    // 데이터 결합
    const combinedBestList = manProducts
      .map((apiProduct) => {
